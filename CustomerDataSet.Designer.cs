...
namespace ReportERP {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataDataTable : global::System.Data.TypedTableBase<CustomerDataRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerDataRow AddCustomerDataRow(int Id, string FirstName, string LastName, string PNumber) {
            ...
            private void InitClass() {
                ...
                this.columnPNumber.MaxLength = 20;
            }
        ...
        public partial class CustomerDataRow : global::System.Data.DataRow {
            ...
            public string PNumber {
                get {
                    try {
                        return ((string)(this[this.tableCustomerData.PNumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'PNumber\' in table \'CustomerData\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCustomerData.PNumberColumn] = value;
                }
            }
            ...
            public bool IsPNumberNull() {
                return this.IsNull(this.tableCustomerData.PNumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetPNumberNull() {
                this[this.tableCustomerData.PNumberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ReportERP.CustomerDataSetTableAdapters {
    ...
    public partial class CustomerDataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CustomerData] WHERE (([Id] = @Original_Id))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CustomerData] ([Id], [FirstName], [LastName], [PNumber]) VALUE" +
                "S (@Id, @FirstName, @LastName, @PNumber)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CustomerData] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] " +
                "= @LastName, [PNumber] = @PNumber WHERE (([Id] = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CustomerConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, PNumber FROM dbo.CustomerData";
        ...
        public virtual int Fill(CustomerDataSet.CustomerDataDataTable dataTable) {
        ...
        public virtual CustomerDataSet.CustomerDataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CustomerDataSet.CustomerDataDataTable dataTable = new CustomerDataSet.CustomerDataDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CustomerDataSet.CustomerDataDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string FirstName, string LastName, string PNumber) {
        ...
        public virtual int Update(int Id, string FirstName, string LastName, string PNumber, int Original_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string PNumber, int Original_Id) {
            return this.Update(Original_Id, FirstName, LastName, PNumber, Original_Id);
        }
    }
